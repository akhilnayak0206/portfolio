...
export default class ContactMe extends Component {
  render() {
    return (
      <div>
        <h1 className="textH1">Hey you can reach me at</h1>
        <a href={`mailto:nnewn3@gmail.com`}>
        <Tooltip label="Mail Me!" position="bottom">
        <SvgIcon className="mailIcon">
          <path fill="#000000" d="M20,18H18V9.25L12,13L6,9.25V18H4V6H5.2L12,10.25L18.8,6H20M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" />
              </SvgIcon>
</Tooltip>     
        </a>
        <a href="https://www.linkedin.com/in/akhil-nayak-808923144"  target="#">
        ...
        <a href="https://github.com/akhilnayak0206"  target="#">
