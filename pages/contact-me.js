          ...
          <div className={`${styles.container} ${styles.mainContactsDiv}`}>
            ...
            <div className={styles.rightContent}>
              <div className={styles.rightContent__title}>
                <h1>
                  Akhil <span>Nayak</span>
                </h1>
                <span>
                  {animationTextP1}
                  <span
                    className={`${
                      animation && developerType
                        ? styles.contact_page__marqueeText
                        : ''
                    }`}
                  >
                    &nbsp;&nbsp;
              ...
              <div className={styles.findMeCard}>
                ...
                <div className={styles.cardContactMe}>
                  <div className={styles.cardContactMe__cardContent}>
                    ...
                    <a
                      href={linkedInUrl}
                      className={styles.cardContactMe__cardContent__title}
                      rel='noreferrer'
                      target='_blank'
                    >
                      Linkedin
