...
import myPic from "../download_1.png";
...
export default function HomePage({ headerFooterData, homepageData, projectData, achievementsData, developerTypeData }) {
  ...
  const { pageTitle, pageDescription, seoKeywords, projectCompleted, projectsCompletedText, 
    section1MotoSubtitle, section1MotoTitle, section2IntroP1, section2IntroTitle,
    developerType, chatPopupText, section2IntroP2, section2IntroP3,
    discoverProjectSubtitle, discoverProjectTitle, viewAllProjectButton, 
    achievementSubtitle, achievementTitle, section1Image, yearsOfExpText, yearsOfExp } = homepageData || {};
      ...
      <div className={styles.homepage}>
        <main>
          ...
          <section className={`${styles.thirdSection}`}>
            <div className={`${styles.thirdSection__topTitle} ${styles.container}`}>
              <h1>{discoverProjectTitle}</h1>
              <span>{discoverProjectSubtitle}</span>
            </div>
            <div className={`${styles.thirdSection__Images} ${styles.container}`}>
                {/* <div className={styles.thirdSection__Images__innerDiv}> */}
                    {
                      projects && projects.map((data,key)=>
                      <div className={styles.thirdSection__Images__innerDiv} key={key}>
          ...
          <section className={`${styles.container} ${styles.fourthSection}`}>
            ...
            >
              <div className={styles.fourthSection__leftSide}>
                <h1 className={styles.achievements_title}>{achievementTitle}</h1>
              </div>
                  ...
                  <div className={styles.fourthSection__rightSide}>
                    {
                      ...
                      <div key={internalKey} className={styles.fourthSection__rightSide__row}>
                        <p>{value?.title}</p>
                        <h2>
...
export async function getServerSideProps({req}) {
  try {
    ...
    return {
      props: { headerFooterData, homepageData, projectData, achievementsData, developerTypeData }
    }
  }
  catch(error){
